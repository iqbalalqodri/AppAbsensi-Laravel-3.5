...
@section('title', 'List Data Jabatan')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">List Data Jabatan</h4>
                <br>
                <a class="btn btn-success" href="/AddData-Jabatan">Tambah Jabatan</a>
                ...
                <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered dataex-html5-export">
                      ...
                      <tbody>
                        ...
                        @forelse($GetJabatan as $data)
                                <tr>
                                    <td>{{$data->position}}</td>
                                    <td><a class="btn btn-info" href="{{url('EditData-Jabatan-'.$data->id)}}"><i class="fa fa-pencil"></i></a> ||
                                      <form action="{{ url('DeleteData-Jabatan-'.$data->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data')">
                                        {{csrf_field()}}
